...
VALUES	
    ...
    , ('MedicationStatement', uuid_generate_v5(uuid_generate_v5(uuid_ns_oid(), 'MIMIC-IV'), 'MedicationStatement'))
    ...
    , ('ObservationVitalSign', uuid_generate_v5(uuid_generate_v5(uuid_ns_oid(), 'MIMIC-IV'), 'ObservationVitalSign'))
