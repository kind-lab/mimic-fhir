...
DROP TABLE IF EXISTS fhir_trm.cs_medication_mixes;
CREATE TABLE fhir_trm.cs_medication_mixes(
    code      VARCHAR NOT NULL
);

WITH medication_mixes AS (
    SELECT DISTINCT 
...
INSERT INTO fhir_trm.cs_medication_mixes 
SELECT code
FROM medication_mixes
